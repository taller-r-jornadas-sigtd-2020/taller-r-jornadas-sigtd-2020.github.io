...
## Presentación
Este sitio web aloja los contenidos del taller "Manejo de datos geográficos mediante R y RStudio", el cual forma parte de la [II Jornada de Sistemas de Información Geográfica (SIG) y Teledetección (TD) libre de Costa Rica](https://www.geografia.fcs.ucr.ac.cr/index.php/laboratorios/313-ii-jornadas-de-sig-2020), organizada por la [Escuela de Geografía de la Universidad de Costa Rica](https://www.geografia.fcs.ucr.ac.cr/).

El sitio contiene tanto las explicaciones teóricas como el código fuente que las ejemplifica, junto con los enlaces a los datos utilizados.

## Introducción
El procesamiento de datos geográficos mediante programas es una alternativa y un complemento al enfoque de procesamiento basado en aplicaciones SIG de escritorio (ej. ArcGIS, QGIS). Entre sus ventajas, pueden mencionarse su flexibilidad y reproducibilidad.
